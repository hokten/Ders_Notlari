...
+----------------+--------------------------------------------------------+
|                |cs karakterinin veya metninin ilk bulunduğu indeksi     |
|indexOf(cs)     |döndürür. Eğer cs karakteri veya metni, metin içerisinde|
|                |bulunmuyorsa -1 döndürür.                               |
+----------------+--------------------------------------------------------+
|                |cs karakterinin veya metnini, metnin bas indeksli       |
|indexOf(k,bas)  |karakterinden başlayarak arar. Bulduğu takdirde indeksi,|
|                |aksi halde -1 döndürür.                                 |
+----------------+--------------------------------------------------------+
|                |cs karakterinin veya metninin son bulunduğu noktanın    |
|lastIndexOf(cs) |ideksin döndürür. Eğer metin içinde bulunmuyorsa -1     |
|                |döndürür                                                |
+----------------+--------------------------------------------------------+
|                |k karakterinin veya metninin ilk bulunduğu indeksi      |
|lastindexOf(k)  |döndürür. Eğer k karakteri veya metni, metin içerisinde |
|                |bulunmuyorsa -1 döndürür.                               |
+----------------+--------------------------------------------------------+
#+END_foo
